...
4. 不得生成“适用领域”“适用对象”“产品特性与设计侧重点”“交互与版式策略”“使用角色”“核心业务对象”“页面构成”等从方案设计、适配分析或说明书写作方法出发的章节或段落。
5. 页面说明必须直接围绕页面功能本身展开，不要写“该截图展示了”“从截图可以看出”等围绕截图本身的套话。
6. 不要写测试说明、研发建议、验收建议、部署建议、模块说明或面向老板/团队负责人的解释。
7. 若需要描述软件特点，只能围绕软件已具备的功能、数据组织、操作路径和结果输出做客观陈述。
