...
def _build_diagram_spec(product_name: str, profile: dict | None = None) -> dict:
    ...
    if architecture_style == "dispatch_flow" or preset_key == "logistics":
        return {
            ...
            "boxes": [
                ...
                {"box": (830, 350, 1180, 560), "title": "仓配与签收层", "body": "用于处理分拨协同、签收回传、回单影像和客户反馈更新，保证仓配节点信息与签收结果连续可查。", "kind": "accent"},
                {"box": (220, 626, 1020, 760), "title": "系统支撑层", "body": "负责接口服务、消息通知、结果导出、运行日志和基础配置，支撑物流项目的页面运行与数据流转。", "kind": "accent"},
            ],
            "arrows": [
                (320, 182, 390, 182),
                (545, 288, 255, 350),
    ...
    if architecture_style == "risk_grid" or preset_key == "supply_chain_finance":
        return {
            ...
            "boxes": [
                ...
                {"box": (680, 536, 1170, 722), "title": "资金与系统支撑层", "body": "负责预警通知、结果导出、运行日志和基础服务支撑，保障分析平台页面、资金处理和结果回写稳定运行。", "kind": "accent"},
            ],
            "arrows": [
                (620, 232, 315, 290),
                (620, 232, 925, 290),
    ...
    return {
        ...
        "boxes": [
            ...
            {"box": (345, 390, 735, 605), "title": "数据组织层", "body": "用于保存页面业务数据、结果记录、统计信息和系统配置，支撑不同页面之间的数据查看与状态同步。", "kind": "accent"},
            {"box": (790, 390, 1180, 620), "title": "系统支撑层", "body": "负责接口服务、结果导出、运行日志、消息通知和基础配置，保障项目页面与业务处理稳定运行。", "kind": "accent"},
        ],
        "arrows": [
            (300, 180, 345, 180),
            (735, 200, 790, 200),
        ...
        "caption": f"图1：{product_name}围绕页面展示、业务处理、数据组织与系统支撑形成项目专属架构。",
    }
